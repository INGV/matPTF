...
The slip distributions for this case study have been produced by the code ANTI-FASc (Automatic Numerical Tsunami Initial conditions) partially based on the code k223d (Herrero and Murphy 2018 available at https://github.com/s-murfy/k223d), in turn based on the slipk2 (available at https://github.com/andherit/slipk2) and trilateration codes (available at https://github.com/andherit/trilateration)
